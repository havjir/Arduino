...
void loop(){
    ...
    // retrieve data from DS3231
    readDS3231time(&bsecond, &bminute, &bhour, &bdayOfWeek, &bdayOfMonth, &bmonth, &byear);
    ...
    sprintf(timestamp_str, "%2d-%02d-%02d %02d:%02d:%02d",byear,bmonth,bdayOfMonth,bhour,bminute,bsecond);
