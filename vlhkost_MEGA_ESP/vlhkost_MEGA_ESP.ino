...
int max_watering_duration = 180;  // Maximal watering time [sec]

int max_hum = 60;   // Optimal humidity [%] - No watering
int half_hum = 57;  // Medium humidity  [%] - Half watering
int low_hum = 52;   // Low humidity     [%] - Full watering
